...
public class ModBlocks {
  ...
  public static final RegistryObject<Block> SOLAR_FURNACE =
      registerBlock(
          "solar_furnace",
          () -> new SolarFurnaceBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.FURNACE)));

  public static final RegistryObject<Block> SOLAR_BLAST_FURNACE =
      registerBlock(
          "solar_blast_furnace",
          () ->
              new SolarBlastFurnaceBlock(
                  BlockBehaviour.Properties.ofFullCopy(Blocks.BLAST_FURNACE)));

  public static final RegistryObject<Block> SOLAR_SMOKER =
      registerBlock(
          "solar_smoker",
          () -> new SolarSmokerBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.SMOKER)));
